    ...
    items: [
      ...
      },
      {
        ...
        items: [
          ...
          { text: '使用 Jetson Containers 部署 ComfyUI', link: '/orin-nano-series/jetson-container' },
    ...
    items: [
      ...
      },
      {
        ...
        items: [
          ...
          { text: 'Deploy ComfyUI with Jetson Containers', link: '/en/orin-nano-series/jetson-container' },
