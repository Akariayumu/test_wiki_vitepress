...
![C1902 front interface layout](/img/c1902-layout-front.png)
...
![C1902 back interface layout](/img/c1902-layout-back.png)

| # | Name | Notes |
|---|------|-------|
| 16 | RTC battery | MX1.25-2P, 3V |
...
![40-pin header](/img/c1902-40pin.webp)
...
More C1902 tutorials and configuration guides:

- [C1902 Flashing Guide](/en/flashing-guide/c1902-flashing)
- [Jetson Basics](/en/orin-nano-series/connect-jetson)
- [JetPack Configuration](/en/orin-nano-series/jtop)
- [Jetson AI Vision](/en/orin-nano-series/opencv)
- [Large Language Models on Jetson](/en/orin-nano-series/ollama)
- [C1901/C1902 USB Device Tree Replacement](/en/orin-nano-series/usb-config)
- [Hardware Downloads](/en/resources/downloads)
