...
hero:
  name: "LinkZee Wiki"
  text: "Kytech Product Documentation"
  tagline: Jetson Orin Carrier Board Documentation
  actions:
    - theme: brand
...
features:
  ...
  - title: Flashing Guide
    details: Complete system flashing for all carrier boards
  - title: Bilingual
    details: Full Chinese and English documentation
---
