...
![4.png](/img/wiki-4.png)

设置USB总是连接到虚拟机，然后打开SDK Manager。

![5.png](/img/wiki-5.png)
...
![image.png](/img/wiki-XjOimage.png)

- 选择 `developer kit version`。

![12.png](/img/wiki-JBF12.png)
...
![image.png](/img/wiki-ftEimage.png)
...
![image.png](/img/wiki-VXwimage.png)
